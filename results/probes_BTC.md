# Lookahead / memorization probes — BTC·daily
...
**Interpretation:** predictions change on mismatched news (change_rate=50%) and placebo accuracy drops toward chance — consistent with genuine news use.
